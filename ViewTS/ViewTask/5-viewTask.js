...
import { createOptionsTask, closeTasksOptions, tasksOptions } from "../../ViewTS/ViewTaskMenu/05-taskMenu.js";
const { taskAlmacen } = tasksElements;
export function renderTasksProyect(proyect, callbacks) {
    if (proyect === null)
        return;
    if (!taskAlmacen) {
    ...
    taskAlmacen === null || taskAlmacen === void 0 ? void 0 : taskAlmacen.appendChild(fragment);
}
// tasks creator
export function createtTaskProyect(proyect, onSave) {
    if (proyect === null) {
...
//# sourceMappingURL=5-viewTask.js.map